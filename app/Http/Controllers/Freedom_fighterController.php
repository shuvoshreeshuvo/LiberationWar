...
class Freedom_fighterController extends Controller
{
    public function index(){
      ...
      return view('Freedom_Fighter.index',compact('periods','ff_titles','freedom_fighters'));
    } 
    ...
    public function freedom_fighter($id)
    {
        ...
        $freedom_fighters = DB::table('freedom_fighters')
                ...
                ->get();
            //dd($events);
        return view('Freedom_Fighter.freedom_fighter_list',compact('periods','ff_titles','freedom_fighters'));
    }
    ...
    public function freedom_fighter_details($id)
    {
        ...
        return view('Freedom_Fighter.freedom_fighter', compact('periods', 'ff_titles','freedom_fighter'));
    }
